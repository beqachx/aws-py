...
from bucket.policy import read_bucket_policy, assign_policy, put_policy
...
# parser.add_argument("-ubf",
#   "--upload_big_file",
#   type=str,
#   help="Upload big file",
# )
...
parser.add_argument(
  "-cp",
  "--create_policy",
  help="Create policy to delete after 120 days",
  action="store_true"
)
...
def main():
  ...
  # if (args.upload_big_file):
  #   print('upload_big_file ran')

  if (args.create_policy):
    put_policy(s3_client)
